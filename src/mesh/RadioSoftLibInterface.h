...
class RadioSoftLibInterface : public RadioInterface, protected concurrency::NotifiedWorkerThread
{
...
// #endif
  ...
  public:
     ...
     */
    static RadioSoftLibInterface *instance;
  ...
  public:
    RadioSoftLibInterface(PhysicalLayer *_iface);
