...
RadioSoftLibInterface::RadioSoftLibInterface(PhysicalLayer *_iface)
    : NotifiedWorkerThread("RadioIf"), iface(_iface) 
    {
    instance = this;
}
...
void INTERRUPT_ATTR RadioSoftLibInterface::isrLevel0Common(PendingISR cause)
{
...
void INTERRUPT_ATTR RadioSoftLibInterface::isrRxLevel0()
{
    isrLevel0Common(ISR_RX);
}

void INTERRUPT_ATTR RadioSoftLibInterface::isrTxLevel0()
{
 ...
 */
RadioSoftLibInterface *RadioSoftLibInterface::instance;

/** Could we send right now (i.e. either not actively receiving or transmitting)? */
bool RadioSoftLibInterface::canSendImmediately()
{
...
bool RadioSoftLibInterface::receiveDetected(uint16_t irq, ulong syncWordHeaderValidFlag, ulong preambleDetectedFlag)
{
...
ErrorCode RadioSoftLibInterface::send(meshtastic_MeshPacket *p)
{
...
meshtastic_QueueStatus RadioSoftLibInterface::getQueueStatus()
{
...
bool RadioSoftLibInterface::canSleep()
{
...
*/
bool RadioSoftLibInterface::isSending()
{
    return sendingPacket != NULL;
}

/** Attempt to cancel a previously sent packet.  Returns true if a packet was found we could cancel */
bool RadioSoftLibInterface::cancelSending(NodeNum from, PacketId id)
{
...
bool RadioSoftLibInterface::findInTxQueue(NodeNum from, PacketId id)
{
...
currently active.
*/
void RadioSoftLibInterface::onNotify(uint32_t notification)
{
    switch (notification) {
    case ISR_TX:
...
void RadioSoftLibInterface::setTransmitDelay()
{
...
void RadioSoftLibInterface::startTransmitTimer(bool withDelay)
{
...
void RadioSoftLibInterface::startTransmitTimerRebroadcast(meshtastic_MeshPacket *p)
{
    // If we have work to do and the timer wasn't already scheduled, schedule it now
    if (!txQueue.empty()) {
 ...
 */
void RadioSoftLibInterface::clampToLateRebroadcastWindow(NodeNum from, PacketId id)
{
 ...
 */
bool RadioSoftLibInterface::removePendingTXPacket(NodeNum from, PacketId id, uint32_t hop_limit_lt)
{
 ...
 */
// void RadioSoftLibInterface::removePending

void RadioSoftLibInterface::handleTransmitInterrupt()
{
...
void RadioSoftLibInterface::completeSending()
{
...
void RadioSoftLibInterface::handleReceiveInterrupt()
{
...
void RadioSoftLibInterface::startReceive()
{
    isReceiving = true;
    powerMon->setState(meshtastic_PowerMon_State_Lora_RXOn);
}

void RadioSoftLibInterface::configHardwareForSend()
{
    powerMon->setState(meshtastic_PowerMon_State_Lora_TXOn);
}

void RadioSoftLibInterface::setStandby()
{
...
bool RadioSoftLibInterface::startSend(meshtastic_MeshPacket *txp)
{
